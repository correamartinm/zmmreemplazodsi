		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#morixezmmreemplazodsi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"morixezmmreemplazodsi-display": {
								"semanticObject": "morixezmmreemplazodsi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=morixe.zmmreemplazodsi",
									"url": sap.ui.require.toUrl("morixe/zmmreemplazodsi")
								}
							}
						}
					}
